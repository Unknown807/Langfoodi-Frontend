...
void main() {
  const jsonMap = {"id": "01","title": "title1","thumbnailId":"001","description": "description here","chef": {"id":"01", "handler": "testHandler", "userName": "user1", "accountCreationDate": "2023-11-08","pinnedConversationIds": ["convoId1"]},"tags": ["lbl1", "lbl2"],"ingredients": [{"name": "eggs", "quantity": 12, "unitOfMeasurement": "whole"}],"recipeSteps": [{"text": "step1", "imageUrl": "www.example.com/imgpath"}],"creationDate": "2023-08-18","lastUpdatedDate": "2023-08-18","kiloCalories":1000,"numberOfServings":20,"servingSize": {"quantity":30,"unitOfMeasurement":"kg"}};
  ...
  group("Recipe detailed model tests", () {
    group("fromJson method tests", () {
      test("json map is converted into model", () {
        ...
        expect(recipeDetailed, RecipeDetailed(
            ...
            "description here",
            "001",
            UserAccount("01", "testHandler", "user1", DateTime.parse("2023-11-08"), null, const ["convoId1"]),
            const ["lbl1", "lbl2"],
    ...
    group("fromJsonStr method tests", () {
      test("json string is converted into model", () {
        // Arrange
        const jsonStr = '"{"id": "01","title": "title1","description": "description here","chef": {"id":"01", "handler": "testHandler", "userName": "user1", "email": "mail@example.com", "password": "Pass123!", "accountCreationDate": "2023-11-08","pinnedConversationIds": ["convoId1"]},"labels": ["lbl1", "lbl2"],"ingredients": [{"name": "eggs", "quantity": 12, "unitOfMeasurement": "whole"}],"recipeSteps": [{"text": "step1", "imageUrl": "www.example.com/imgpath"}],"creationDate": "2023-08-18","lastUpdatedDate": "2023-08-18"}"';
